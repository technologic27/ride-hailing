...
PROFILE = default
PROJECT_NAME = gojek-ds-assignments
...
## Make Dataset
data:
	$(PYTHON_INTERPRETER) src/data/clean_raw.py data/raw data/interim
...
metrics:
	$(PYTHON_INTERPRETER) reports/generate_metrics.py data/processed data/interim data/interim reports

train:
	$(PYTHON_INTERPRETER) src/models/train_model.py data/processed src/models models

predict:
	$(PYTHON_INTERPRETER) src/models/predict_model.py data/interim models reports
